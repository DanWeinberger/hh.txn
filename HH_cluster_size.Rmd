...
model_jags_covar<-jags.model(model_spec, 
                       ...
                       data=list( 
                                 ...
                                 'choose_kj_mat'=choose_kj_mat,
                                  'max.contacts' = 1:dim(ds.vax.array)[2]
                                 ),
                       n.adapt=10000, 
                       n.chains=3)
...
CPI.ratio.samples <- log(CPI1.samples / CPI2.samples)
CPI.ratio.hdi <-  exp(c(median(CPI.ratio.samples), t(hdi(CPI.ratio.samples, credMass = 0.95))))
CPI.ratio.hdi
