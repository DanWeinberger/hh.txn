...
hh_list <- pblapply(1:1000,gen.hh, irr.vax=1, IRR.comm=1 )
...
CPI1 = 20/(207+20)  #Prob infection in HH size=1 m[2,1]
...
## Call stan model
Follow code from Zelner's github
...
```{r}
m <- stan("./longini_stan_vector.stan",
          iter = 2000,
          chains = 2,
