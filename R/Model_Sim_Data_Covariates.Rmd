...
data.sim <- gen_sim_data(popN=2400, IRR.vax=1)
data.sim.vax <- gen_sim_data(popN=2400, IRR.vax=0.2)

prop.inf.vax <- 1-sum(data.sim.vax$nY)/2400
prop.inf.unvax <- 1-sum(data.sim$nY)/2400
prop.inf.vax/prop.inf.unvax
